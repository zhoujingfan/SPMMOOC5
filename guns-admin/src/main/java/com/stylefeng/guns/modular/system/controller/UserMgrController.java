...
public class UserMgrController extends BaseController {
     ...
     * 跳转到添加通知界面
     */
    @RequestMapping("/notice_add/{userId}")
    public String addNotice(@PathVariable Integer userId, Model model) {
        model.addAttribute(userId);
        LogObjectHolder.me().set(userId);
        return PREFIX + "user_addnotice.html";
    }
